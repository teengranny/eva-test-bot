...
def ask_eva(question, user_name="Студент"):
    # Тот самый исправленный промпт без лишних хвостов
    system_prompt = f"""
...
ТВОЙ СТИЛЬ:
- Деловой, лаконичный, грамотный. Никаких фраз про "базу знаний".
- Минимум воды. Используй не более ОДНОГО смайлика на всё сообщение.
- Ты — эксперт. Отвечай уверенно и по существу.
